...
sdb_raw%>% ggplot(aes(x = `Social Y or N`,y=`SDB Rate`, fill=`Social Y or N`)) +geom_boxplot(fill ="slateblue",alpha = 0.2) + labs(title = "Social status of Focal and corresponding average SDB", fill= "Social status of Focal")
```
